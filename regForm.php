            ...
            <div class="card card-registration my-4">
                <div class="row g-0">
                    <div class="col-xl-6 d-none d-xl-block">
                        <img src="images/user.png" alt="Sample photo" class="img-fluid" style="border-top-left-radius: .25rem; border-bottom-left-radius: .25rem; height:90%;
                margin:50px;
                margin-top:30px;" />
                    </div>
                    <div class="col-xl-6">
                        <div class="card-body p-md-5 text-black">
                            <form method="post" action="">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        <div class="for-outline">
                                            <input type="text" id="" name="name" class="form-control form-control-lg"
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        <div class="for-outline">
                                            <input type="text" id="" name="address" class="form-control form-control-lg"
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        <div class="for-outline">
                                            <input type="text" id="" name="city" class="form-control form-control-lg"
